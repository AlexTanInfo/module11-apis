...
years <- GET("http://data.unhcr.org/wiki/index.php/API_Documentation.html")
test <- GET("http://data2.unhcr.org/en/situations")
years
test

# What is the "country code" for the "Syrian Arab Republic"?
country.code <- GET("http://data.unhcr.org/syrianrefugees/regional.php")
country.code
